...
Future getUser(String searchWord, BuildContext context) async {
  if (searchWord.isEmpty) {
    return [];
  } else {
    final url = Uri.parse('${baseUrl()}/api/user/getUser/$searchWord');
    ...
    if (data.statusCode == 200) {
      ...
      print(data.body);
      showAlertDialog(context, 'No Such User');
      return [];
    }
  }
}
