...
Future getDiagnosisDetails(BuildContext context, String dID) async {
  final url = Uri.parse('${baseUrl()}/api/diagnosis/getDiagnosisDetails/$dID');
  ...
  if (data.statusCode == 200) {
    ...
    showAlertDialog(context, 'No Diagnosis Available,\n${data.body}');
    return [];
  }
}
