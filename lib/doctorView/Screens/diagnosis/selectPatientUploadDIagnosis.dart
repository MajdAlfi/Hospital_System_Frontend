...
class selectPatientUploadDiagnosis extends StatefulWidget {
  selectPatientUploadDiagnosis({super.key});
  final searchWord = TextEditingController();
  @override
  State<selectPatientUploadDiagnosis> createState() =>
      _selectPatientUploadDiagnosisState();
}

class _selectPatientUploadDiagnosisState
    extends State<selectPatientUploadDiagnosis> {
  @override
