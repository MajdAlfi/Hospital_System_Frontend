...
class selectPatientReport extends StatefulWidget {
  selectPatientReport({super.key});
  final searchWord = TextEditingController();
  @override
  State<selectPatientReport> createState() => _selectPatientReportState();
}

class _selectPatientReportState extends State<selectPatientReport> {
  @override
